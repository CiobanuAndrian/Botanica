    ...
    <footer className="bg-zinc-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Coloana 1 - Despre */}
          <div>
            <h3 className="text-xl font-bold mb-4">BOTANICA</h3>
            <p className="text-zinc-400 text-sm">
              Magazin de plante. Aducem natura în casa ta.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/despre" className="text-zinc-400 hover:text-white transition-colors">
                  Despre noi
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/termeni" className="text-zinc-400 hover:text-white transition-colors">
                  Termeni și condiții
                </a>
              </li>
              <li>
                <a href="/politica" className="text-zinc-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-zinc-800 mt-8 pt-8 text-center text-sm text-zinc-400">
          <p>© 2026 BOTANICA. Toate drepturile rezervate.</p>
        </div>
      </div>
    </footer>
  );
